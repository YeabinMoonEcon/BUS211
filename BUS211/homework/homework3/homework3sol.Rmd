...
# other solution with mutate and across
# mutate(across(c(`Total Grads - % of cohort`, `Dropped Out - % of cohort`), parse_number))
# mutate(across(`Total Grads - % of cohort`: `Dropped Out - % of cohort`, parse_number))
# mutate(across(ends_with(" - % of cohort"), parse_number))
```
