...
class PresidentGuesser:
    ...
    def __call__(self, question):
        ...
        candidates = [d['name'] for d in training_data]
...
#I understood how to get all the values from the dictionaries which had "name"
#as keys but was unable to make it so the president for 2023 be Joe Biden. 

#Time taken: 45 minutes [will need to do strong refresher on Python as well]
