...
class PresidentGuesser:
    ...
    def __call__(self, question):
        ...
        required_time = time.strptime(date[-21:-1], "%b %d %X %Y")       
        candidates = [i for i in self._lookup if (self._lookup[i][0]<required_time and self._lookup[i][1]>required_time)]
