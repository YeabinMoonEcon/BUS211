...
\begin{frame}
	...
	\begin{itemize}
%		\item The production is a combination of multiple tasks
%
%		\item Workers can acquire task-specific human capital in different occupations.
%		\vfill
...
\end{enumerate}
%\vfill
%	\item The initial labor market conditions would affect the innate-ability match
\vfill
