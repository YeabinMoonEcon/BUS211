...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item Task-specific human capital approach could provide an explanation for cohort effects %since workers are forced to develop their human capital according to the tasks assigned
	\end{itemize}
\end{frame}
