# We will exercise our skills by employing string manipulation techniques with the dates of US presidents in office. More importantly, this code will introduce some of the object-oriented structures of future works (potentially). Don't be scared!

# This exercise is meant to be easy, but it will depend on your prior experience/knowledge. The attached Python code takes a question and returns a guess of who the president was. The PresidentGusser receives a query and provides a guess of the respective US president. You must retrieve the time frame being inquired about and return the name of the corresponding US president. 
